...
.legal-embed{padding:0;background:#f4efe0}.legal-embed .legal-shell{width:100%}.legal-embed .legal-card{border:0;border-radius:0;box-shadow:none;padding:28px}.legal-embed .legal-links{display:none}
`;
