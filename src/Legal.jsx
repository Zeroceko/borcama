...
.legal-back,.legal-card,.legal-callout,.legal-links a{border-width:1px;border-color:#14160f24}.legal-back,.legal-card{box-shadow:0 12px 32px #14160f0d}
`;
