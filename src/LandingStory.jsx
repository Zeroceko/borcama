...
@media(max-width:900px){.ls-nav-link{display:none}.ls-hero-in{grid-template-columns:1fr;padding:65px 0 95px}.ls-chaos{min-height:470px;width:min(630px,100%)}.ls-problem-grid{grid-template-columns:1fr}.ls-moments{grid-template-columns:repeat(2,1fr)}.ls-benefits,.ls-steps,.ls-pricing-grid{grid-template-columns:1fr}.ls-step{min-height:0}.ls-feeling-stage{grid-template-columns:1fr}.ls-before,.ls-after{min-height:0}.ls-proof-row{align-items:flex-start;flex-direction:column}.ls-proof-items{justify-content:flex-start}}
        ...
        <section id="paketler" className="ls-section ls-pricing">
          <div className="ls-shell">
            <SectionHead
              ...
              text="Takibe ücretsiz başla. Tüm kişisel analizleri açmak için Pro’ya geç veya yalnızca reklamları tek ödemeyle kaldır."
            />
            <div className="ls-pricing-grid">
              ...
              <PriceCard
                badge="TEK ÖDEME"
                title="Borcama Reklamsız"
                price="₺199"
                suffix="/ ömür boyu"
                description="Pro analizleri olmadan sade ve reklamsız kullanım."
                items={["Ücretsiz paketteki tüm takip araçları", "Ömür boyu reklam gösterilmez", "Tek seferlik ödeme", "Pro analizleri dahil değildir"]}
                action="Reklamları kaldır"
